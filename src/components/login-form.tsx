            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              <div className="grid gap-6">
                <div className="flex flex-col gap-4">
                  <Button type="button" onClick={signInWithGoogle} variant="outline" className="w-full cursor-pointer">
                ...
                <div className="grid gap-6">
                  ...
                  <Button disabled={isLoading} type="submit" className="w-full cursor-pointer">
                    {isLoading ? <LoaderCircle className="animate-spin" size={24} /> : 'Login'}
                  </Button>
                </div>
